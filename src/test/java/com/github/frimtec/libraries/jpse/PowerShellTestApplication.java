...
class PowerShellTestApplication {
    ...
    public static void main(String[] args) throws IOException {
        ...
        output = executor.execute(Paths.get(".\\src\\test\\resources\\test.ps1"), arguments).getResult();
        System.out.println(" output = " + output);

        System.out.println("Execute scipt from classpath: ");
        output = executor.execute(PowerShellTestApplication.class.getResourceAsStream("/test.ps1"), arguments).getResult();
        System.out.println(" output = " + output);
    }
}
